...
<div class="container">
					...
					<table class="table table-striped">
						<tbody>
							<tr>
								...
								<td>:</td>
								<td><input type="text" name="nama" class="form-control" /><?= $data->no_pendaftaran ?></td>
							</tr>
							...
							<tr>
								...
								<td>:</td>
								<td>
									<?= $data->tempat_lahir, $data->tanggal - $data->bulan - $data->tahun ?>
								</td>
							</tr>
	...
	<!-- Data Sekolah -->
		<div class="row">
			<div class="col-md-11 col-md-offset-1">
				<h2 style="margin-bottom: 3%; margin-top: 3%">DATA SEKOLAH ASAL</h2>
				<table class="table table-striped">
					<tbody>
						<tr>
							<td>Nama Sekolah</td>
	...
	<!-- Biodata Orang Tua -->
		...
		<div class="row" style="margin-bottom: 3%;">
			...
			<div class="col-md-2 col-md-offset-4">
				<a href="<?= base_url('siswa/input_data') ?>" class="btn btn-success" name="input_data">Kembali</a>
			</div>
		</div>
